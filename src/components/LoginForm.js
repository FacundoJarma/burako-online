            ...
            <div className="w-full max-w-md">
                <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl shadow-xl p-6">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold mb-2">Incia Sesion</h1>
                        <p className="text-slate-200">Ingresa a Burako Online</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="••••••••"
                                    required
                                    className="w-full text-sm px-4 py-2 bg-slate-600 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all"
                                />
                                <button
                                    type="button"
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-slate-300">
                            ¿No tienes cuenta?{" "}
                            <a href="/register" className="text-slate-100 font-medium hover:underline">
                                Regístrate
                            </a>
                        </p>
                    </div>
